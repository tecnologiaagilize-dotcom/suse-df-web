...
BEGIN
    ...
    -- 3. Logar Acesso (Auditoria)
    -- Registra que o QR Code foi lido publicamente
    INSERT INTO public.health_audit_logs (
        actor_id, -- NULL para acesso público/anônimo
        target_profile_id, 
        resource_type, 
        action_type, 
        details,
    ...
    VALUES (
        ...
        NULL, -- Não conseguimos pegar IP confiável dentro da RPC sem headers, frontend pode enviar ou deixamos null
        'Public Health Check'
    );
