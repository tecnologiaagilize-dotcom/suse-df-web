...
import { LogOut, AlertTriangle, MapPin, Camera, ShieldAlert, X, Upload, Check, CheckCircle, Home, User, Activity, HeartPulse, Copy, Share2, Mic, MicOff } from 'lucide-react';
          ...
          <div className="flex justify-between h-24 items-center">
            <div className="flex flex-col text-white">
              ...
              <span className="text-xs font-mono text-blue-100 opacity-90">
                SISTEMA UNIFICADO DE SUPORTE E EMERGÊNCIA - SUSE™ v1.3.41
              </span>
